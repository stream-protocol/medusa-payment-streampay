...
function calculateTransactionCost(amount, isDonation) {
    ...
    const donationAmount = isDonation ? parseFloat(prompt("Enter Donation Amount USD in USDC:")) || 1 : 1;
    ...
    // Display the results
    console.log(`Transaction Fee Cost: ${transactionFeeCost} USDC`);
    console.log(`Tax Amount: ${taxAmount} USDC`);
    console.log(`Merchant Fee Cost: ${merchantFeeCost} USDC`);
    console.log(`StreamPay Fee Cost: ${streampayFeeCost} USDC`);
    if (isDonation) {
        console.log(`Donation Amount: ${donationAmount} USDC`);
    }
