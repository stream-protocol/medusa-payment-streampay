...
export class StreamPayWrapper {
  ...
  constructor(options: StreamPayOptions, logger?: Logger) {
    ...
    switch (this.options.mode) {
      case "production":
        ...
        break;
      case "uat":
        this.url = "https://api-preprod.streampayments.app/apis/hermes";
        break;
      case "test":
      default:
        this.url = "https://api-preprod.streampayments.app/apis/pg-sandbox";
        break;
    }
  }

  async postPaymentRequestToStreamPay(
    ...
    const url =
      /* this.options.mode == "uat"
        ? "https://api-preprod.streampayments.app/apis/pg-sandbox"
        :*/ this.url;
  ...
  async createStreamPayStandardRequest(
    amount: string,
  ...
  async getStreamPayTransactionStatus(
    merchantId: string,
    merchantTransactionId: string,
    apiNewEndpoint?: string
  ...
  async capture(p: PaymentResponseData): Promise<PaymentCheckStatusResponse> {
    ...
    const result = await this.getStreamPayTransactionStatus(
      merchantId,
      merchantTransactionId
    );
  ...
  async postRefundRequestToStreamPay(
