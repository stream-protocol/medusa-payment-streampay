...
exports.getStreamPayments = void 0;
function getStreamPayments(req) {
    return __awaiter(this, void 0, void 0, function () {
        var order_id, orderService, streampayBase, order, paymentIds, swapPayments, payments;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    streampayBase = req.scope.resolve("StreamPaymentsProviderService");
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Promise.all(paymentIds.map(function (payment) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_e) {
                                switch (_e.label) {
                                    case 0: return [4 /*yield*/, streampayBase
                                            .getStream()
...
exports.getStreamPayments = getStreamPayments;