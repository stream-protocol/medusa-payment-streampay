import {
  ...
  import { StreamPayments } from "../models/streampayments"; // Updated import path
  import { StreamPaymentsRepository } from "../repositories/streampayments"; // Updated import path
  import { PublicKey, Transaction, SystemProgram, Connection } from "@solana/web3.js";
  import axios from "axios"; // Import Axios for API requests
  
  class StreamPaymentsProviderService extends AbstractPaymentService {
    protected manager_: EntityManager;
    protected transactionManager_: EntityManager;
  
    private streamPaymentsRepository: StreamPaymentsRepository; // Updated variable name
    ...
    constructor(
      ...
      this.streamPaymentsRepository = streamPayRepository; // Updated variable assignment
  ...
  export default StreamPaymentsProviderService;