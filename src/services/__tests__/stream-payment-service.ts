...
import { StreamPayment } from "../models/stream-payment"; // Adjust the import path based on your project structure
import { StreamPaymentRepository } from "../repositories/stream-payment"; // Adjust the import path based on your project structure
